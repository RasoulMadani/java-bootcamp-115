...
public class LambdaUtil {
    ...
    public static Function<BigDecimal, String> toDollarStringFunction() {
        //todo
        return (bigDecimal -> STR."$\{bigDecimal.toString()}");
    }
    ...
    public static IntUnaryOperator boundedRandomIntSupplier() {
        //todo
        return (boundInt)->new Random().nextInt(boundInt);
    }
    ...
    public static IntUnaryOperator intSquareOperation() {
        //todo
        return (inte)-> (int) Math.pow(inte,2);
    }
    ...
    public static BiFunction<IntUnaryOperator, IntPredicate, IntUnaryOperator> functionToConditionalFunction() {
        //todo :: extra points
        return (intFunction, condition) -> (int value) -> condition.test(value) ? intFunction.applyAsInt(value) : value;
    }
